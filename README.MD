...
The `CL-ENVIRONMENTS` package has to be imported instead of the
`COMMON-LISP` package, as it shadows the CL special forms to ensure they
are walked by the code-walker, if required.
